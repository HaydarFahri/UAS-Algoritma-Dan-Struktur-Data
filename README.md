...
TREE
1. kita dapat memasuka data tree pada int main dengan fungsi untuk mengurutkan data yang telah dimasukan secara acak.
2. kemudian data tree akan di tampilkan. 
3. kemudian kita dapat mencari data pada tree pada int target.
4. jika tidak ada data yang ditemukan maka akan muncul text "data tidak ditemukan pada pohon" dan sebaliknya jika data yang dicari ada maka akan muncul text "data ditemukan"
